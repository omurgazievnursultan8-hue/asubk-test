...
> Last updated: 2026-08-04 (взыскание: **получена действующая редакция Порядка — №41 от
> 06.07.2026, 16 глав, 69 пунктов**; модуль спроектирован по предыдущей («99 пунктов»).
> Сверка — `docs/normativ/2026-08-04-sverka-red-N41.md`: таблица перенумерации + 12
> содержательных расхождений. Письмо ГФХ переиздано редакцией 2 —
> `docs/voprosy-zakazchiku/2026-08-04-vzyskanie.md`, письмо от 02.08 отменено. Ранее в тот же
> день: пакет передачи P14 переиздан редакцией 2) — _(update this date every time you edit)_
...
| Приведение модуля взыскания к редакции Порядка №41 | Волна правок по `docs/normativ/2026-08-04-sverka-red-N41.md` | 2026-08-04 | 7 шагов наряда: перенумерация ссылок → 1-й день просрочки вместо 6-го → пороги и паузы → маршруты → новые ветви и предусловия → справочник видов → письмо ГФХ. Пакет передачи P14 (редакция 2) отдавать в разработку **после** шагов 1–2: базы отсчёта половины сроков меняются |
...
- 🔴 **Модуль взыскания построен на устаревшей редакции Порядка.** Действующая — №41 от
  06.07.2026 (`docs/normativ/poryadok-2026-07-06-N41.pdf`); ссылки на пункты в спеке (~70),
  ADR (77 в 27 файлах), макете (64 поля `point:`), ТЗ (23) и задачах (9) указывают на прежнюю
  нумерацию. Кроме номеров разошлись 12 содержательных мест — самое дорогое: средний риск
