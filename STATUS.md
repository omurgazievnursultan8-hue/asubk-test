...
> Last updated: 2026-07-11 (мокап заявки: вкладка «Документы» — командный центр: сегментный прогресс по стадиям ЖЦ с % последней стадии «Подтверждено ГФ», конвейер стадий как чипы-фильтры, очередь «Требуют вашего действия» по роли с переходом-подсветкой к строке, P3-R46, `scripts/inspect/docs-cockpit-check.mjs` 15/15) — _(update this date every time you edit)_
