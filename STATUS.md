...
> Last updated: 2026-07-27 (собран пакет передачи модуля заёмщика разработчикам: ТЗ `requirements/tz/04-zaemshchik.html` + задачи `P4-R6…P4-R25` в `TODO.md` + читаемый бэклог `docs/tasks/p4-zaemshchik-tasks.html`; эталон — `mockups/borrower/borrower.html`, смоук 165/165) — _(update this date every time you edit)_
...
- 2026-07-27 — **Модуль заёмщика подготовлен к передаче разработчикам.** Пакет из трёх артефактов:
  ...
  модель)» в `TODO.md` с задачами **P4-R6…P4-R25** в строгом порядке зависимостей; читаемый бэклог
  `docs/tasks/p4-zaemshchik-tasks.html` (20 карточек, 5 групп-шагов, раскрывашки «Для разработчика»).
