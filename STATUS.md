...
> Last updated: 2026-07-28 (модуль заёмщика передан разработчикам постановкой на постройку `docs/tasks/p4-zaemshchik-tasks.html` — эпики `Э0…Э14`, комплект = она + макет `mockups/borrower/borrower.html`; смоук 307/307) — _(update this date every time you edit)_
...
| Пакеты передачи по модулям (мокап + ТЗ + задачи) | admin | 2026-07-19 | Готовы: залог (P13), взыскание (P14), кредит (P15, 2026-07-26), **заёмщик (P4-R6…R25, 2026-07-27)**. Следующий — по решению владельца |
