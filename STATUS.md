...
> Last updated: 2026-08-04 (взыскание: пакет передачи разработчикам переиздан редакцией 2 —
> `docs/tasks/p14-collection-tasks.html` (23 задачи, 7 этапов, JSON-остров по `docs/tasks/FORMAT.md`,
> первый файл в этом формате) + `requirements/tz/13-collection.html` (20 разделов, реконсилиация
> против ADR `0043…0054`) + реестр `TODO.md` P14-R1…R23; `scripts/check_tasks.py` 0 ошибок.
> Закрывает разрыв, отмеченный в предыдущей записи) — _(update this date every time you edit)_
