...
> Last updated: 2026-07-10 (мокап взыскания: процессы вместо кредитов, M:N кредит↔процесс, три оверлея; мокап заявки: вкладка «Заключения» переработана — назначение отделов, ЖЦ черновик→внесено, отрицательный вердикт как гейт комиссии, P3-R41; список заявок — фильтры по стадии P3-R42, по территории/исполнителю P3-R43, переключатель «Таблица / Карточки» P3-R44) — _(update this date every time you edit)_
