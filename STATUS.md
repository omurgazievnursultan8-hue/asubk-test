...
> Last updated: 2026-07-28 (модуль заёмщика передан разработчикам постановкой на постройку `docs/tasks/p4-zaemshchik-tasks.html` — эпики `Э0…Э14`, комплект = она + макет `mockups/borrower/borrower.html`; смоук 309/309; ТЗ `requirements/tz/04-zaemshchik.html` синхронизировано с макетом) — _(update this date every time you edit)_
