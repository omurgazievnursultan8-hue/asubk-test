...
ok('видов мер 66 (было 51 — Task 2/4 расщепили «Определение суда» на 5 + добавили «Постановление апелляционной инстанции»; было 59 до наряда п.7 — п.7а добавил «Повторное предъявление ИЛ»; было 60 до наряда п.1 — добавил «Дополнительное решение суда» (ADR-0046) и «Определение о повороте исполнения» (ADR-0049); было 62 до наряда МП-11 — ADR-0047 расщепил «Мировое соглашение» на «Проект…»/«Определение об утверждении…»/«Констатация нарушения…», −1+3; было 64 до шага 4 наряда сверки — `ADR-0066` добавил два выхода п. 36: «Жалоба на акты судебного исполнителя» и «Направление материалов в САК на банкротство»)',
   g.ev('MEASURE_KINDS.length') === 66);
