...
ok('рамка считает вручение, сторно и расхождение',   // счётчики сняты с #claimsFrame
   /без подтверждения вручения <b>0<\/b> \(п\. 20\.1\) · сторнировано <b>2<\/b> · сумма документа разошлась с требованием у <b>112<\/b>/
...
/* Две группы справочника затравкой не покрыты — у неё нет ни одного дела с терминалом
   «Признана безнадёжной» / «Списана». Это дыра ЗАТРАВКИ, а не справочника, и она
   названа числом, чтобы не сойти за полноту. */
ok('затравка достаёт семь групп из девяти — 4 и 5.2 в ней не сеются',
