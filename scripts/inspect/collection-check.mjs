...
ok('видов мер 62 (было 51 — Task 2/4 расщепили «Определение суда» на 5 + добавили «Постановление апелляционной инстанции»; было 59 до наряда п.7 — п.7а добавил «Повторное предъявление ИЛ»; было 60 до наряда п.1 — добавил «Дополнительное решение суда» (ADR-0046) и «Определение о повороте исполнения» (ADR-0049))',
   g.ev('MEASURE_KINDS.length') === 62);
