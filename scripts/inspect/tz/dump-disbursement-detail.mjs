// scripts/inspect/tz/dump-disbursement-detail.mjs
// Dumps a single disbursement (Освоение) detail page for TZ inspection.
// Usage: node scripts/inspect/tz/dump-disbursement-detail.mjs [id]
...
await page.goto(BASE + `disbursements/${recordId}`, { waitUntil: 'networkidle', timeout: 60000 });
...
await page.screenshot({ path: `.auth/tz-disbursement-${recordId}.png`, fullPage: true });
await ctx.close();
console.log('\n=== DONE ===');
