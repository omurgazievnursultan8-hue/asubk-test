...
(() => {
  ...
  ok(1, st.objects.length === 10 && st.indicators.length === 229 && own1.length === 155 &&
       ...
       st.dims.length === 81 && ST.registry().length === 310 && badSrc.length === 0 &&
...
(() => {
  ...
  ok(172, a172.bad.length === 0 && a172.seen === 16108 && a172.som === 5075 && dates172.length === 59 && objs172.length === 10 &&
        own172.length === 2194 && leg172.length === 34 && legSom172 === 0,
  ...
  ok(181, st.registry.length === 310 && nInd === 229 && nDim === 81 &&
        ...
        withCols === 193 && aggN === 117 && withCols + aggN === st.registry.length &&
