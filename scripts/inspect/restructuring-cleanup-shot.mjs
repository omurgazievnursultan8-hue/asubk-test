...
// Пара вкладок расчёта в тот же день названа по сделке: сначала ЗАДАЮТ параметры изменения,
// потом СМОТРЯТ, что расчёт даёт. Вторая зовётся по своему предмету — «Результат расчёта»;
// «Было и стало» называло форму показа, а не предмет, и продержалось один день.
const TABS = ['Пакет документов','Заключения','Параметры','Результат расчёта','Комитет и решение','Оформление','История'];
